...
public class MyGdxGame implements ApplicationListener {
	...
	public void create() {
		...
		dropImage = new Texture("blueraindrop.png.png");

		rainMusic = Gdx.audio.newMusic(Gdx.files.internal("rain.mp3.mp3"));
		rainMusic.setLooping(true);
		rainMusic.play();

		dropSound = Gdx.audio.newSound(Gdx.files.internal("drop.wav.wav"));
		...
		backgroundTexture = new Texture("download.jpg");
	...
	public void render() {
		...
		yourBitmapFontName.draw(batch, ScorePlayer1, 700, 100); // generate score for player1
		// yourBitmapFontName.draw(batch, ScorePlayer2, 25, 100); //generates score for player 2
		// batch.draw(player1, player1Sprite.x, player1Sprite.y);//draws player1
		// batch.draw(player2, player2Sprite.x, player2Sprite.y);// draws player2
